...
const Navbar = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all ${scrolled ? 'bg-gray-900/80' : 'bg-gray-900/50'} backdrop-blur-md border-b border-white/10`}>
      <nav className="container mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          <a href="#" className="flex items-center">
            <img src="/assets/profile.svg" alt="Arnob Banik" className="h-14 w-auto min-w-[200px]" />
          </a>
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 mobile-menu-bg rounded-lg">
